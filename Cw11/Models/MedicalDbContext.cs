...
namespace Cw11.Models
{
    public class MedicalDbContext : DbContext
    {
        ...
        private void seedData(ModelBuilder modelBuilder)
        {
            ...
            dictMedicament.Add(new Medicament { IdMedicament = 1, Name = "Entocort", Description = "Jakiś opis leku", Type = "Steryd" });
            dictMedicament.Add(new Medicament { IdMedicament = 2, Name = "Immuran", Description = "Jakiś opis leku2", Type = "Immunosupresant" });
            var dictDoctors = new List<Doctor>();
            dictDoctors.Add(new Doctor { IdDoctor = 1, FirstName = "Jan", LastName = "Kowalski", Email = "jankowalski@gmail.com" });
            dictDoctors.Add(new Doctor { IdDoctor = 2, FirstName = "Adrianna", LastName = "Leszczyńska", Email = "aleszcz@gmail.com" });
            var dictPatients = new List<Patient>();
            dictPatients.Add(new Patient { IdPatient = 1, FirstName = "Dawid", LastName = "Gerwatowski", BirthDate = DateTime.Parse("30-01-1994") });
            dictPatients.Add(new Patient { IdPatient = 2, FirstName = "Alan", LastName = "Nala", BirthDate = DateTime.Parse("11-11-1991") });
